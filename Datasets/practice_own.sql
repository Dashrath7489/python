...
-- this query return all the Females information.
select * from users where gender = 'female';

-- this query return all the Males information. 
select * from users where gender = 'male';

-- this is the retun output acording the condition
select * from users where date_of_birth < '1996-01-01';

-- this is return the id is greter than condition
...
-- this is show where the entery is null and not null
